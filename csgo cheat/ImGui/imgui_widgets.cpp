...
bool ImGui::Checkbox(const char* label, bool* v)
{
	...
	if (*v)
	{
		...
		// window->DrawList->AddRect(check_bb.Min, check_bb.Max, ImColor(10 / 255.f, 12 / 255.f, 14 / 255.f, g.Style.Alpha), 10);
		// window->DrawList->AddRect(check_bb.Min + ImVec2(1, 1), check_bb.Max - ImVec2(1, 1), ImColor(45 / 255.f, 47 / 255.f, 54 / 255.f, g.Style.Alpha), 10);
		window->DrawList->AddCircleFilled(check_bb.Min + ImVec2(it_pos_active->second, 6), it_size_active->second, ImColor(173, 255, 47, (int)(g.Style.Alpha * 255)), 16);
	}
	else
	{
		...
		// window->DrawList->AddRect(check_bb.Min, check_bb.Max, ImColor(10 / 255.f, 12 / 255.f, 14 / 255.f, g.Style.Alpha), 10);
		// window->DrawList->AddRect(check_bb.Min + ImVec2(1, 1), check_bb.Max - ImVec2(1, 1), ImColor(45 / 255.f, 47 / 255.f, 54 / 255.f, g.Style.Alpha), 10);
		window->DrawList->AddCircleFilled(check_bb.Min + ImVec2(it_pos_active->second, 6), it_size_active->second, ImColor(76, 87, 97, (int)(g.Style.Alpha * 255)), 16);
	}
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags, int items)
{
	...
	const ImVec4 hover_dis = ImVec4(50 / 255.f, 205 / 255.f, 50 / 255.f, g.Style.Alpha);
	...
	window->DrawList->AddText(cb_bb.Min + ImVec2(44, 1), ImColor(1.0f, 1.0f, 1.0f, style.Alpha), preview_value);
	window->DrawList->PopClipRect();
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
	...
	window->DrawList->AddRect(cb_bb.Min, cb_bb.Max, ImColor(10 / 255.f, 12 / 255.f, 14 / 255.f, g.Style.Alpha));
	window->DrawList->AddRect(cb_bb.Min + ImVec2(1, 1), cb_bb.Max - ImVec2(1, 1), ImColor(45 / 255.f, 47 / 255.f, 54 / 255.f, g.Style.Alpha * 255));
	window->DrawList->AddRect(cb_bb.Min + ImVec2(1, 1), cb_bb.Max - ImVec2(1, 1), ImColor(50 / 255.f, 205 / 255.f, 50 / 255.f, it_hcolor->second.w));
...
bool ImGui::Keybind(const char* str_id, int* current_key, int* key_style) {
	...
	if (g.ActiveId == id) {
		...
		if (key_style) {
			...
			if (popup_open) {
				SetNextWindowSize(ImVec2(52, CalcMaxPopupHeightFromItemCount(2)));
   ...
   // window->DrawList->AddRect(ImVec2(frame_bb.Min), ImVec2(frame_bb.Max), ImColor(38, 38, 42, (int)(g.Style.Alpha * 255)), 2.0f);
	...
	window->DrawList->AddText(frame_bb.Min + ImVec2(0, 0), g.ActiveId == id ? ImColor(34, 149, 255) : ImColor(255 / 255.f, 255 / 255.f, 255 / 255.f, g.Style.Alpha), buf_display);
	PopFont();
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
	...
	window->DrawList->AddRectFilled(slider_bb.Min, ImVec2(slider_bb.Min.x + it_old_value->second, slider_bb.Max.y), ImColor(50, 205, 50, (int)(g.Style.Alpha * 255)), 2);
	...
	const ImVec4 hover_dis = ImVec4(50 / 255.f, 205 / 255.f, 50 / 255.f / 255.f, g.Style.Alpha);
	float deltatime = 1.5f * ImGui::GetIO().DeltaTime;
	static std::map<ImGuiID, ImVec4> hover_color;
	auto it_hcolor = hover_color.find(id);
	if (it_hcolor == hover_color.end())
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
	...
	if (!is_multiline)
	{
		window->DrawList->AddRectFilled(frame_bb.Min, frame_bb.Max, ImColor(0.26f, 0.59f, 0.98f, 1.00f), 4.0f);
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
	...
	const ImVec4 hover_dis = ImVec4(50 / 255.f, 205 / 255.f, 50 / 255.f, 1.f);
	float deltatime = 1.5f * ImGui::GetIO().DeltaTime;
