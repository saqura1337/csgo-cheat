...
{
public:
    CTraceFilterPlayersOnlySkipOne(C_ClientEntity* ent)
    {
        pEnt = ent;
    }
    bool ShouldHitEntity(IHandleEntity* pEntityHandle, int /*contentsMask*/)
    {
        return ( void* )( pEntityHandle ) != ( void* )( pEnt ) && ((C_ClientEntity*)pEntityHandle)->GetClientClass()->m_ClassID == ClassId_CCSPlayer;
    }
    virtual TraceType GetTraceType() const
    {
        return TraceType::TRACE_ENTITIES_ONLY;
