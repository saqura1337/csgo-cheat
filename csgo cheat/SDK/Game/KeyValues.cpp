...
{
    return ( ( FindKey_t )( g_sdk.address_list.m_KeyValuesFindKey ) )( this, strKeyName, bCreate );
}

const char* C_KeyValues::GetString( C_KeyValues* pThis, const char* strKeyName, const char* strDefaultValue )
{
    return ( ( GetString_t )( g_sdk.address_list.m_KeyValuesGetString ) )( pThis, strKeyName, strDefaultValue );
}
...
{
    return ( ( LoadFromBuffer_t )( g_sdk.address_list.m_KeyValuesLoadFromBuffer ) )( pThis, pszFirst, pszSecond, pSomething, pAnother, pLast, pAnother2 );
}
...
void C_KeyValues::SetString( const char* strName, const char* strValue ) 
{
    ...
    if ( pKeyValues )
        ( ( SetString_t )( g_sdk.address_list.m_KeyValuesSetString ) )( pKeyValues, strValue );
}
