...
{
public:
	NETVAR(m_flDefuseCountDown, float_t, FNV32("CPlantedC4"), FNV32("m_flDefuseCountDown"));
	NETVAR(m_hBombDefuser, int32_t, FNV32("CPlantedC4"), FNV32("m_hBombDefuser"));
	NETVAR(m_flC4Blow, float_t, FNV32("CPlantedC4"), FNV32("m_flC4Blow"));
	NETVAR(m_bBombDefused, bool, FNV32("CPlantedC4"), FNV32("m_bBombDefused"));
};
