...
public:
	...
	virtual void ClearRecords( int32_t iPlayerID ) { g_sdk.m_CachedPlayerRecords[ iPlayerID ].clear( ); };
	...
	virtual std::deque < C_LagRecord >& GetPlayerRecords( int32_t iPlayerID ) { return g_sdk.m_CachedPlayerRecords[ iPlayerID ]; };
	virtual C_LagRecord& GetPreviousRecord( int32_t iPlayerID ) { return g_sdk.m_CachedPlayerRecords[ iPlayerID ].back( ); };
private:
