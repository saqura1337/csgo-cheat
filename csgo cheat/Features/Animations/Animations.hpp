...
{
public:
	void Init(C_BasePlayer* e, C_LagRecord& record);
	void ResolveYaw();
};
...
public:
	...
	virtual void RecalculateVelocity(C_BasePlayer* pPlayer, C_LagRecord& LagRecord, C_LagRecord PreviousRecord, bool bHasPreviousRecord = false);
	//virtual void ResolveInit(C_BasePlayer* e, C_LagRecord& LagRecord, C_LagRecord PreviousRecord, int32_t iRotationMode);
	//virtual void ResolveInit(C_BasePlayer* e, C_LagRecord& record);
